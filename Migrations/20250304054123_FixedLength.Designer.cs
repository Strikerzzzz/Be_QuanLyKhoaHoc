...
namespace Be_QuanLyKhoaHoc.Migrations
{
    ...
    [Migration("20250304054123_FixedLength")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Be_QuanLyKhoaHoc.Identity.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Be_QuanLyKhoaHoc.Identity.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "49a6b68d-63ef-4447-a6b4-993d40ea7626",
                            CreatedAt = new DateTime(2025, 3, 4, 5, 41, 21, 0, DateTimeKind.Utc).AddTicks(2251),
                            Email = "admin@ntt.com",
                            EmailConfirmed = true,
                            FullName = "Admin",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAl+vbNiHDHxLopxLRTPFurIadFY1FxMxIHIBjbhYhu9nHEOMsNBgvDw9RP9j//ZcA==",
            ...
            modelBuilder.Entity("Be_QuanLyKhoaHoc.Identity.Entities.MultipleChoiceQuestion", b =>
                {
                    ...
                    b.Property<int>("AnswerGroupNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Be_QuanLyKhoaHoc.Identity.Entities.Exam", b =>
                {
                    b.HasOne("Be_QuanLyKhoaHoc.Identity.Entities.Course", "Course")
                        .WithOne("Exam")
                        .HasForeignKey("Be_QuanLyKhoaHoc.Identity.Entities.Exam", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Be_QuanLyKhoaHoc.Identity.Entities.RefreshToken", b =>
                {
                    b.HasOne("Be_QuanLyKhoaHoc.Identity.Entities.User", "User")
                        .WithMany()
